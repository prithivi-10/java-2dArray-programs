...
public class sub_2dArray {
    public static void main(String args[]) {
        Scanner sc = new Scanner (System.in);

        System.out.println("Program to print subraction of two matrices:");
        System.out.println("------------------------------------------");
        ...
        if(r1==r2 && c1==c2) {
            ...
            System.out.println("Elements after subracting of MAT1 and MAT2 are:");
            ...
            System.out.println("");
            System.out.println("Please enter the valid rows and colmns for subraction:");
        }
    }
}